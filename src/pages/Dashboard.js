                ...
                <nav x-bind:class="! open ? 'w-0' : 'w-[280px]'"
                    ...
                    <div class="pb-6 mt-4 overflow-x-hidden overflow-y-auto ">
                        <ul class="mb-8 text-sm">
                            <li>
                                <a href="#"
                                    class="flex items-center px-8 py-4 text-gray-100 bg-blue-600 dark:text-gray-200 dark:bg-blue-500 dark:hover:bg-gray-700 hover:bg-blue-500">
                                ...
                                <div class="justify-center hidden mr-4 md:flex">
                                    <div class=" xl:w-96">
                                        <div class="relative flex flex-wrap items-center w-full ">
                                            <input type="search"
                                                class="form-control relative flex-auto min-w-0 block w-72 px-3 py-1.5 text-base font-normal text-gray-700 bg-white  dark:text-gray-100  border border-solid border-gray-300 dark:border-gray-800 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white dark:bg-gray-800  focus:border-b dark:border-gray-700lue-600 focus:outline-none"
                                                placeholder="Search"/>
                                            <button
